  ...
  return (
    <ErrorBoundary>
      <ActivePetProvider>
        ...
        <Stack.Screen name="tutor-points" options={{ headerShown: true, title: 'Pontos de Tutor' }} />
        ...
        <Stack.Screen name="games/runner" options={{ headerShown: true, animation: 'slide_from_bottom' }} />
