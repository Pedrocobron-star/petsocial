...
// ============================================================================
// Lógica de merge — junta pet_events (com recorrência), vacinas, parasitas,
// vet_visits em AgendaItem[] ordenado por occurs_at.
// ============================================================================
function mergeIntoAgenda(
  raw: {
    events: PetEvent[];
    logs: PetEventLog[];
...
// ============================================================================
// Agrupa AgendaItem[] por dia
// ============================================================================
function groupByDay(items: AgendaItem[]): { dayKey: string; dayLabel: string; items: AgendaItem[] }[] {
  ...
  return Array.from(groups.entries())
    .map(([dayKey, items]) => {
      ...
      return { dayKey, dayLabel: label, items };
    })
