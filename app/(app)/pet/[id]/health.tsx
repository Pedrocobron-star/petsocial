      ...
      <ScrollView contentContainerStyle={{ padding: 16, gap: 12, paddingBottom: 110 }}>
        ...
        {pet && summary && healthIncomplete ? (
          ...
          >
            ...
            <Text style={{ fontFamily: FONTS.body, fontSize: 13, color: theme.textMuted, lineHeight: 19 }}>
              Registre a primeira vacina, vermífugo ou consulta do {pet.name}. Leva 2 minutos e a
              saúde dele começa a ganhar vida aqui.
            </Text>
            <Link href={`/pet/${id}/vaccinations`} asChild>
              <Pressable
                accessibilityRole="button"
                accessibilityLabel="Registrar vacinas"
                style={{
