...
<body>
  ...
  <div class="footer">
    ${
      isPro
        ? `Documento gerado pelo Pet Social Pro em ${today} &bull; pet.social`
        : `Documento gerado pelo Pet Social em ${today} &bull; pet.social &bull; <strong>Upgrade pra Pet Pro pra remover a marca d'água</strong>`
    }
  </div>
</body>
</html>`;
